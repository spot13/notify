...
$('body').append('<div id=\"notif_wrapper\">  </div>');
wr = $('#notif_wrapper');

$('body').append('<div id=\"notif_temp\">  </div>');
tm = $('#notif_temp');
tm.hide();
...
function getannouncement() {
		...
		http.open("GET", "resources/php/live_notify.php", true);
		...
		if(http.readyState == 4) {
			...
			if(getCookie('live_notify' + cr[1]) != 'true')
			{
				...
				wr.append('<div class=\"notification\" id=\"live_notify' + i + '\" > <div class="live_notify_top"></div> <div class="live_notify_mid"> <div class=\"notif_content\"> ' + cr[0] + ' </div> <div class=\"live_notify_footer\"> <input class=\"live_notify_chk\" type=\"checkbox\" /> <span class=\"spn\"> don\'t show again. </span>  <img width=\"24px\" height=\"24px\" class=\"img_c\" id=\"live_notify' + i + 'img' + cr[1] + '\" src=\"resources/x.png\"/> </div> </div> <div class="live_notify_bot"></div> </div>');
